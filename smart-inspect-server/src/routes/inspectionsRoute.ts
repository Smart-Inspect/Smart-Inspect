...
router.get('/view/:id/download-layout', authorize(permissions.ENGINEER), downloadLayout);
...
router.get('/view-assigned/:projectId', authorize(permissions.ENGINEER), viewAssignedInspections);
